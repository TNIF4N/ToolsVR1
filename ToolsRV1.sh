...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR    :  Tuan IF4N  "$i"                  "
echo $i""$pu"  WhatsApp  :  0895397xxxxx"$i"              "
echo $i""$pu"  GMAIL     :  ifancrf2@gmail.com"$i"   "
echo $i""$pu"  YOUTUBE   :  Fan Gaming "$i"               "
echo $i""$pu"  INSTAGRAM :  @ifanhermawan03"$i"               "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $ku"Facebook :"$i" Tuan IF4N"
echo $ku"YouTube  :"$i" Fan Gaming"
echo $ku"WhatsApp :"$i" 0895397xxxx"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { Fan Gaming }"
exit
fi
